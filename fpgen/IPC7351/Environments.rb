...
module IPC7351
    ...
    Environments = {
        ...
        "Gull Wing Pitch <= 0.625 mm" => {
            "L"   => [ 0.15,  0.25, -0.04, 0.12, 0.01],
            "N"   => [ 0.35,  0.35, -0.02, 0.25, 0.01],
            "M"   => [ 0.55,  0.45,  0.01, 0.50, 0.01],
            "HS"  => [ 0.55,  0.25, -0.02, 0.50, 0.01],
        },
        "Gull Wing Pitch > 0.625 mm" => {
        ...
        "Under-Body Outward L Height <= 10mm" => {
            "L"   => [ 0.30, -0.20,  0.30, 0.25, 0.01],
            "N"   => [ 0.50, -0.10,  0.40, 0.50, 0.01],
            "M"   => [ 0.70,  0.00,  0.50, 1.00, 0.01],
            "HS"  => [ 0.50, -0.10,  0.40, 0.50, 0.01],
        },
        "Under-Body Outward L Height > 10mm" => {
            "L"   => [ 0.40, -0.20,  0.40, 0.25, 0.01],
            "N"   => [ 0.70, -0.10,  0.50, 0.50, 0.01],
            "M"   => [ 1.00,  0.00,  0.60, 1.00, 0.01],
            "HS"  => [ 0.70, -0.10,  0.50, 0.50, 0.01],
        },
    };
end
